...
public class SendMessageTest extends TestBase {
    ...
    public void loggedInUserCanInitiateLeadForFirstTime() {
        ...
        refresh();
        openLoginPage();
        softAssert.assertTrue(adminPage.isLeadAdded("ksa","Tohamy","126606622","159203",driver));
        softAssert.assertAll();
        clearData();
    }
    ...
    public void loggedInUserCanInitiateLeadForSecondTime() {
        ...
        clearData();
        openLoginPage();
        softAssert.assertTrue(adminPage.isLeadAdded("ksa","md","1118608831","159203",driver));
        softAssert.assertAll();
        clearData();
    }
